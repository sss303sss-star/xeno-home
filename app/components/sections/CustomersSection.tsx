...
const row1Repeated = [...row1Logos, ...row1Logos, ...row1Logos];
const row2Repeated = [...row2Logos, ...row2Logos, ...row2Logos];
...
export default function CustomersSection() {
  return (
    ...
    >
      ...
      {/* Customer logos — 2 rows marquee */}
      <div className="pt-[40px] md:pt-[80px] flex flex-col gap-[40px] md:gap-[60px] shrink-0 w-full overflow-hidden">
        {/* Top Row: Flowing to the Right */}
        ...
        {/* Bottom Row: Flowing to the Left */}
        <div className={styles.marqueeContainer}>
